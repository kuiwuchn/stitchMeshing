//
//  Dual.h
//  Single_Strip_Mesh_Simplification
//
//  Created by kui wu on 2/21/13.
//  Copyright (c) 2013 kui wu. All rights reserved.
//
...
#endif /* defined(__Single_Strip_Mesh_Simplification__Dual__) */